/// @file Utils.hpp
/// @brief Contains utility functions for polygon decomposition using DCEL.
...
///
/// This function takes two pointers to Line objects and checks whether their respective line segments intersect
/// or not.
///
/// @param l1 A pointer to the first Line object
/// @param l2 A pointer to the second Line object
